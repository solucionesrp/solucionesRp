...
const ContactPage: React.FC = () => {
  ...
  const serviceOptions = [
    ...
    { value: 'pagina-web', label: 'Desarrollo de Página Web' },
    { value: 'app-movil', label: 'Desarrollo de Aplicación Móvil' },
  ...
  const contactInfo = [
    {
      ...
      title: 'Teléfono',
      content: '+6 9 9388 8939 ',
      link: 'tel:+69993888939'
    },
    {
      icon: <FaEnvelope className="w-6 h-6" />,
      title: 'Email',
      content: 'contacto@solucionesrp.com',
      link: 'mailto:contacto@solucionesrp.com'
    },
    {
