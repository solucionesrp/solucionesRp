...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({ 
  ...
  return (
    <motion.button
      onClick={handleClick}
      className={`fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 z-50 ${className}`}
      whileHover={{ 
        scale: 1.1,
